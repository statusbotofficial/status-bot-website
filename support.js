        ...
        supportInput.addEventListener('input', () => {
            ...
            supportInput.style.height = Math.min(supportInput.scrollHeight, 100) + 'px';
        });
        ...
        async function sendMessage() {
            ...
            try {
                ...
                addMessageToChat('Sorry, I encountered an error. Please try again or contact support at our Discord server.', 'ai');
            } finally {
        ...
        async function getAIResponse(userMessage) {
            ...
            const response = await fetch(
                "https://status-bot-backend.onrender.com/api/support/ai",
                {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json"
