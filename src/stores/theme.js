...
const THEMES = {
  default: {
    ...
    '--glow-color-2': 'rgba(81, 112, 255, 0.35)',
        '--glow-color-1': 'rgba(120, 120, 120, 0.25)',
        '--glow-color-2': 'rgba(120, 120, 120, 0.15)',
    '--border-color': '#333333',
  },
  dark: {
    name: 'Dark',
  ...
  light: {
    ...
    '--glow-color-1': 'rgba(38, 48, 182, 0.08)',
    '--glow-color-2': 'rgba(38, 48, 182, 0.04)',
        '--glow-color-1': 'rgba(142, 68, 173, 0.45)',
        '--glow-color-2': 'rgba(142, 68, 173, 0.25)',
    '--border-color': '#bbbbbb',
  },
  sunset: {
    name: 'Sunset',
    ...
    '--glow-color-2': 'rgba(184, 107, 255, 0.2)',
        '--glow-color-1': 'rgba(26, 42, 79, 0.18)',
        '--glow-color-2': 'rgba(123, 227, 90, 0.12)',
    '--border-color': '#b86bff',
  },
  obsidian: {
    name: 'Obsidian',
    ...
    '--glow-color-2': 'rgba(142, 68, 173, 0.15)',
        '--glow-color-1': 'rgba(176, 255, 109, 0.07)',
        '--glow-color-2': 'rgba(234, 255, 176, 0.05)',
    '--border-color': '#8e44ad',
  },
  sapphire: {
    name: 'Sapphire',
