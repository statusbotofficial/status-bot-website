...
const commands = ref([
  ...
  { id: 32, name: '/give', description: "Give XP or balance to a user (Admin).", category: 'admin' },
  { id: 33, name: '/take', description: "Take XP or balance from a user (Admin).", category: 'admin' }
])
